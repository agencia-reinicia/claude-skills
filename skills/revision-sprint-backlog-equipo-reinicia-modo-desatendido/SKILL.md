...
description: >
  ...
  v1.6 (06/06/2026): abre el automatismo al Equipo — Override 1.2 pasa de allowlist de piloto a lista de exclusión (procesa Equipo Operativo completo + POs Pablo Losada y Óscar Díez; excluye Síntaris hasta soportar la columna AK, se procesa supervisado). Altas nuevas auto-incluidas. Resto sincronizado con la supervisada v3.9. Historial en la tabla de Versiones.
---
