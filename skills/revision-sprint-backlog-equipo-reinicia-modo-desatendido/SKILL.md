...
description: >
  ...
  v1.6.1 (07/06/2026): abre el automatismo al Equipo — Override 1.2 pasa de allowlist de piloto a lista de exclusión (procesa Equipo Operativo completo + POs Pablo Losada y Óscar Díez; excluye Síntaris hasta soportar la columna AK, se procesa supervisado). Altas nuevas auto-incluidas. Limpieza de pins a un sprint/carpeta concretos (detección dinámica, Override 1.0). Sincronizada con la supervisada v3.9.
---
