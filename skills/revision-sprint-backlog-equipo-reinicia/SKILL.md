...
description: >
  ...
  v3.8 (31/05/2026): detección determinista de carpeta de sprint + patrón de fichero Excel-Clickup-Sprint + allowlist piloto; PASO 6c resolución producto→tarea; Mejoras 6/11 obligatorias cada pase; compuerta DoD por evidencia sin sello parcial; Cliq por unique_name. Historial completo en la tabla de Versiones.
---
...
##### 🚦 Compuerta de sellado — Definición de Hecho (DoD) OBLIGATORIA (v3.8 — por evidencia, sin sello parcial)
