...
description: >
  ...
  v3.9 (06/06/2026): Mejora 6 refresca Col D vía filter_tasks por tag de sprint en lote (no N× get_task; +barato y resiliente a 502); la compuerta DoD invalida el sello previo (NO CERRADA) si falla; documentados los específicos del desatendido (resiliencia, alcance Col D, routine_id). Historial completo en la tabla de Versiones.
---
